...
#samagents view -b ../../all.fake.shortread.sorted.bam "$PBID" > mapped.shortread.bam

# 3. create mpileup
samagents view -bS ccs.sam > ccs.bam
samagents sort ccs.bam > ccs.sorted.bam
samagents mpileup --min-BQ $MIN_BQ -f fake.fasta -s ccs.sorted.bam > ccs.mpileup

#samagents merge out.bam mapped.shortread.bam ccs.sorted.bam
#samagents mpileup --min-BQ $MIN_BQ -f fake.fasta -s out.bam > ccs.mpileup
...
#samagents view -bS ccs.maize4.sam > ccs.maize4.bam
#samagents sort ccs.maize4.bam > ccs.maize4.sorted.bam
#samagents index ccs.maize4.sorted.bam
EOM
