...
def link_files(src_dir, out_dir='./'):
    ...
    hq_fastq2 = os.path.join(os.path.abspath(src_dir), 'tasks', 'pbtranscript2agents.tasks.collect_polish-0', 'all_arrowed_hq.fastq')
    ...
    cluster_csv2 = os.path.join(os.path.abspath(src_dir), 'tasks', 'pbtranscript2agents.tasks.collect_polish-0', 'report.csv')
    # location for classify report in IsoSeq1 and 2
    primer_csv = os.path.join(os.path.abspath(src_dir), 'tasks', 'pbcoreagents.tasks.gather_csv-1', 'file.csv')
